...
#import <AdSetQDAAdSDK/AdSetQDANativeAdObject.h>
#import <AdSetQDAAdSDK/AdSetQDAAdMaterial.h>
@class AdSetQDANativeExpressAd;

NS_ASSUME_NONNULL_BEGIN

@interface AdSetQDANativeExpressAd : NSObject

// 自渲染广告对象
@property(nonatomic,strong) AdSetQDANativeAdObject *adObject;
// 模板视图
