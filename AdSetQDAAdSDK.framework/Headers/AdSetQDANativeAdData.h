...
@class AdSetQDAAdMaterial;

NS_ASSUME_NONNULL_BEGIN

@interface AdSetQDAMediaInfo: NSObject
/// 素材宽
...
@interface AdSetQDANativeAdData : NSObject
...
/// 素材地址
@property (nonatomic, strong, readonly) NSArray <AdSetQDAMediaInfo *> *imageUrls;
/// 视频类素材描述
@property (nonatomic, strong, readonly) AdSetQDAMediaInfo *videoAdInfo;
